    ...
    <div id="wrapper">
      ...
      <nav id="navbar">
        ...
        <div id="content">
            ...
            <p class="text" id="gorna">
                <b>Fermentacja górna</b> – Po zadaniu brzeczki nastawnej drożdżami następuje fermentacja, w trakcie której drożdże nie osiadają na dnie fermentora, lecz gromadzą się na powierzchni brzeczki. Proces fermentacji przebiega w temperaturze 16-24 °C. Przy warzeniu piwa metodą górnej fermentacji stosuje się odpowiednie szczepy drożdży z gatunku Saccharomyces cerevisiae czyli tzw. drożdże górnej fermentacji.

                Użycie fermentacji górnej oraz odpowiednich drożdży powoduje, że proces fermentacji przebiega znacznie szybciej, a piwo zawiera większą ilość wyższych alkoholi oraz estrów, stanowiących o bogatszym bukiecie piwa. W przeciwieństwie do fermentacji dolnej fermentacja górna stosowana jest od najdawniejszych czasów, gdyż pierwotnie nie znano metod chłodzenia i wykorzystywano naturalne temperatury otoczenia.
