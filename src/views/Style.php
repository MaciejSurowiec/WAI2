...
<body>
    <div id="wrapper">
        ...
        <div id="content">
            <h2>Na tej podstronie są przedstawione różne style piwne.</h2>

            <div class="Styl" id="porter">
                <h2>Porter</h2>
                <img class="szdj" src="static/img/porter.jpg">
                <p class="tekst">
                    Ciemne, mocne piwo <a href="Historia#gorna">górnej fermentacji</a> o barwie od rubinowej do czarnej, pochodzące z Anglii.Początkowo piwo typu porter było dość mocne, o zawartości ekstraktu słodowego do 15% i alkoholu do 6,5%, warzone ze słodu ciemnego. Obecnie angielskie portery są słabsze (ekstrakt do 11%, alkohol do 5%). Do ich warzenia jako słodu bazowego używa się słodu jasnego, a barwę uzyskuje przez dodatek słodu ciemnego, palonego, karmelowego. Stosuje się też dodatki niesłodowe w postaci kukurydzy i cukru.
                    Istnieje również polska odmianna portera nazywana Porterem Bałtyckim. Od 2016 roku trzecia sobota stycznia jest obchodzone Święto Porteru Bałtyckiego.
                </p>
            </div>


            <div class="Styl" id="pilzner">
                <h2>Pilzner</h2>
                <img class="szdj" src="static/img/pils.jpg">
                <p class="tekst">
                    Typ piwa <a href="Historia#dolna">fermentacji dolnej</a>. Nazwę swoją piwo to zawdzięcza miejscowości Pilzno (Plzeň) w Czechach, gdzie w 1842 roku opracowano jego oryginalną recepturę. Po raz pierwszy w obrocie handlowym znalazło się to piwo pod marką Pilsner Urquell.<br>
                    ...
                    <br><b>Surowce</b> – miękka woda z niską zawartością minerałów, chmiel żatecki, morawski słód jęczmienny, czeskie drożdże dolnej fermentacji.

                    <br><b>Wygląd</b> – barwa piwa od jasnożółtej do jasnobursztynowej. Piana biała, trwała, obfita, drobnopęcherzykowa i gęsta. Piwo powinno być bardzo lub doskonale klarowne.

                    <br> <b>Aromat</b> – na pierwszym planie wyczuwalne są wyraźne ziołowo-korzenne aromaty czeskich chmieli. Na drugim planie wyczuwa się aromaty od słodu – słodkie, herbatnikowe, rzadziej karmelowe. Dopuszcza się delikatne aromaty diacetylu.

                    <br> <b> Smak</b> – początkowo wyczuwalne słodkie smaki słodowe (czasem karmelowe), następnie wyraźna smak chmielu, a na koniec intensywna goryczka. Piwo powinno być rześkie, orzeźwiające, z półwytrawnym finiszem. Może być czasem lekko kwaskowe. Dopuszczalny jest lekki smak diacetylu na drugim planie. Goryczka od średniej do mocnej; może zalegać po przełknięciu.
                </p>
            </div>


            <div class="Styl" id="gose">
                <h2>Gose</h2>
                <img class="szdj" src="static/img/gose.jpg">
                <p class="tekst">
                    Odmiana piwa pszenicznego warzonego w Niemczech, w okolicach miejscowości Lipska i Goslar (przez które przepływa rzeka Gose). Uznawane za jedno z najstarszych piw na świecie (czasy cesarza Ottona III, około 996 r.). Tradycyjnie powstawało metodą <a href="Historia#spontan">spontanicznej fermentacji</a>, obecnie warzone przy użyciu drożdży <a href="Historia#gorna">górnej fermentacji</a> i dodanie bakterii kwasu mlekowego lub słodu zakwaszającego. Co nietypowe dla piw niemieckich, w procesie warzenia dodawana jest kolendra i sól. W smaku wyraźnie kwaśne (co przywołuje na myśl lambika), słone, delikatnie chmielowe i ziołowe. Alkohol waha się na poziomie 4-5% obj.
</p>
            </div>


            <div class="Styl" id="lambic">
                <h2>Lambic</h2>
                <img class="szdj" src="static/img/lambic.jpg">
                <p class="tekst">
                    Belgijski rodzaj piwa <a href="Historia#spontan">fermentacji spontanicznej</a> produkowanego ze słodu jęczmiennego z dodatkiem pszenicy.

                    Metoda fermentacji piwa lambic za pomocą szczepów dzikich drożdży jest najstarszą znaną metodą produkcji piwa.<br>
            ...
            <div class="Styl" id="stout">
                <h2>Stout</h2>
                <img class="szdj" src="static/img/stout.jpg">
                <p class="tekst">
                    Ciemne piwo <a href="Historia#gorna">górnej fermentacji</a>, rodzaj ale. Zdaniem niektórych stout wywodzi się bezpośrednio od porteru (nazwa użyta pierwszy raz w 1721 roku, na określenie ciemnego piwa warzonego z palonego słodu), inni zaś twierdzą, że obie nazwy są tożsame (chociaż określenie stout było używane już wcześniej, pojawiając się pierwszy raz w 1677 roku). Najbardziej znanymi przedstawicielami są piwa Guinness oraz Murphy's Irish Stout.

                    Stout jest wytwarzany z mocno prażonego słodu jęczmiennego i cechuje się silną goryczką związaną z wysoką zawartością chmielu. Najpopularniejsze są wytrawne stouty (dry i bitter stout). Poza Irlandią i Szkocją piwo stout jest produkowane m.in. w Australii.
                </p>

            </div>

            <div class="Styl" id="witbier">
                <h2>Witbier</h2>
                <img class="szdj" src="static/img/witbier.jpg">
                <p class="tekst">
            ...
            <div class="Styl" id="ipa">
                <h2>IPA</h2>
                <img class="szdj" src="static/img/ipa.jpg">
                <p class="tekst">
                    Piwo <a href="Historia#gorna">górnej fermentacji</a> z mocnym chmielowym aromatem i w związku z tym, również bardzo charakterystycznym posmakiem goryczki. To piwo powstało po to, żeby mieszkańcy brytyjskich kolonii mogli orzeźwić się w upalne dni. Tradycyjne brytyjskie piwa źle znosiły długie podróże statkami i nawet na najszybszych kliprach potrafiły się zepsuć zanim trafiły na stoły w Indiach. Na szczęście brytyjscy piwowarzy wiedzieli, że chmiel ma właściwości konserwujące i dlatego uwarzyli dla swoich rodaków mieszkających za oceanem piwo z odpowiednio większą dawką szyszek chmielowych. To był strzał w dziesiątkę. Takie piwo bez problemu znosiło dalekie podróże.
                </p>
            </div>

            <div class="Styl" id="apa">
                <h2>APA</h2>
                <img class="szdj" src="static/img/apa.jpg">
                <p class="tekst">
                    American Pale Ale. Jasne, lekkie, szczodrze nachmielone, przeważnie dość goryczkowe i bardzo aromatyczne piwo <a href="Historia#gorna">górnej fermentacji</a> . APA nie są piwami mocnymi, to raczej lekkie i orzeźwiające pozycje. Goryczka w tym stylu także nie powinna wykręcać języka i twarzy w grymasie.
    ...
    APA występują oczywiście w różnych wariantach i podzielić je możemy ze względu na kraj pochodzenia użytych odmian chmielu. Na tablicy w pubie czy na etykiecie możecie więc odnaleźć: New Zealand Pale Ale (NZPA), Polish Pale Ale (PPA), English Pale Ale (EPA) czy Australian Pale Ale. Ilu piwowarów, tyle pomysłów. Do dyspozycji są przecież chmiele Słoweńskie, Francuskie, Niemieckie, Japońskie czy z RPA.
            ...
            <div class="Styl" id="ris">
                <h2>RIS</h2>
                <img class="szdj" src="static/img/ris.jpg">
                <p class="tekst">
                    Rosyjski stout imperialny to piwo <a href="Historia#gorna">górnej fermentacji</a> o bardzo bogatym aromacie, składającym się przede wszystkim z chmielu, alkoholu, ciemnych owoców, palonego zboża, a także kawy bądź gorzkiej czekolady. Kolor tego trunku w zależności od rodzaju waha się pomiędzy bardzo ciemnym burgundem a typową czernią. Piwo jest nieprzezroczyste, a występująca na nim piana bardzo gęsta. Zróżnicowany i wyjątkowo intensywny smak pozwala wyczuć nuty palonego zboża, estrów owocowych, czekolady, a także palonych rodzynek bądź smoły. Trunek jest bardzo mocny zarówno w smaku, jak i zapachu, jednak interpretacja tego gatunku pomiędzy angielskimi a amerykańskimi wersjami nieco różni się od siebie. Gęstość początkowa w przypadku tego piwa wynosi <a href="Historia#blg"> 18,5-27°Blg</a>, natomiast końcowa <a href="Historia#blg">4,5–7,5°Blg</a>. Goryczka mieści się zwykle w przedziale <a href="Historia#ibu">50-90 IBU</a>.
                    Piwo to nie było wcale warzone w Rosji, a na terenia Anglii. Orginalna receptura stouta musiała zostać zmieniona żeby mogła przetrwać tak długą podróż, dlatego to zawartością alokoholu bliżej mu do portera.
                </p>
            </div>
